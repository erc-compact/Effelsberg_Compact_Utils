...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Split a filterbank file by frequency. Author: Fazal. Version 18July2025")
    parser.add_argument("-i", "--infile", required=True, help="Input .fil file path")
    parser.add_argument("-c", "--cutoff", type=float, required=True, help="Cutoff frequency in MHz")
    parser.add_argument("-l", "--out_low", required=True, help="Output file for lower band")
    parser.add_argument("-u", "--out_high", required=True, help="Output file for upper band")
    parser.add_argument("-g", "--gulp", type=int, default=16384, help="Number of samples per gulp")
